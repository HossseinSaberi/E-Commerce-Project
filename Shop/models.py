...
from .managers import ExcistProductManager, NotExcistProductManager, SubmittedShopManager , DeletedShopManager , DraftShopManager
...
class Product(models.Model):
    objects = models.Manager()    
    excist_product = ExcistProductManager()
    not_excist_product = NotExcistProductManager()
    ...
    product_main_image = models.ImageField(
        'Product Main Image',  upload_to='productImage/', height_field=None, width_field=None , null=True , blank=True)
